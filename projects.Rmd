...
Pick a dataset from the following list and do the project following the Project Detail file, 
...
You can use **Excel** or **R** to complete the tasks. If you use R and LaTeX you will get 3 additional points.
